...
let deliveryDayFromCheck = "";
let onChangeCheck = false;
...
const AdditionalInfo = () => {
  ...
  const setDeliveryDayFromCheck = (event) => {
    deliveryDayFromCheck += event.target.value + " ";
    sat = deliveryDayFromCheck.includes("Saturday");
    sun = deliveryDayFromCheck.includes("Sunday");
    mon = deliveryDayFromCheck.includes("Monday");
    wed = deliveryDayFromCheck.includes("Wednesday");
    tue = deliveryDayFromCheck.includes("Tuesday");
    thu = deliveryDayFromCheck.includes("Thursday");
    fri = deliveryDayFromCheck.includes("Friday");

    setDeliveryDay(deliveryDayFromCheck);
